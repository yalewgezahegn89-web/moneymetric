...
import type { LoanResult } from "@/calculators/engine/types";
...
export function LoanAmortizationChart({ result }: LoanAmortizationChartProps) {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-500 sr-only">
        Chart showing remaining loan balance decreasing over the loan term
      </p>
      <p className="mt-2 text-sm text-gray-600">
        Your remaining loan balance decreases from{" "}
